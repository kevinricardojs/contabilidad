...
class EmpresasControllerTest < ActionController::TestCase
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post :create, empresa: { direccion: @empresa.direccion, nit: @empresa.nit, nombre: @empresa.nombre, telefono: @empresa.telefono, zona: @empresa.zona }
    end
  ...
  test "should update empresa" do
    patch :update, id: @empresa, empresa: { direccion: @empresa.direccion, nit: @empresa.nit, nombre: @empresa.nombre, telefono: @empresa.telefono, zona: @empresa.zona }
    assert_redirected_to empresa_path(assigns(:empresa))
  end
